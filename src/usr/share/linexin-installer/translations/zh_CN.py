translations = {
            ...
            "Everything is set up for you. Thank you for choosing ArqOS.": "一切都已为您设置好。感谢您选择 ArqOS。",
            "Reboot the system to finish installation.": "重新启动系统以完成安装。",
            "Everything is set up for you. Thank you for choosing ArqOS.\nReboot the system to finish installation.": "一切都已为您设置好。感谢您选择 ArqOS。\n重新启动系统以完成安装。",
            "Reboot": "重新启动",
            ...
            "The selected partition will be replaced with ArqOS.": "选定的分区将被 ArqOS 替换。",
    ...
    "Download ArqOS-suggested Flatpaks": "下载 ArqOS 推荐的 Flatpak 应用",
