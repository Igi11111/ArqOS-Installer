translations = {
            ...
            "The selected partition will be replaced with ArqOS.": "Выбранный раздел будет заменен на ArqOS.",
            ...
            "ArqOS (Current One)": "ArqOS (Текущий)",
    ...
    "Download ArqOS-suggested Flatpaks": "Загрузить рекомендованные ArqOS Flatpak-пакеты",
